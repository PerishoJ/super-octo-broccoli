...
public class HqUtils {
     ...
     */
    public static void buildCarrier(RobotController rc, MapLocation newLoc) throws GameActionException {
     ...
     */
    public static void buildAnchorSTD(RobotController rc) throws GameActionException {
     ...
     */
    public static void buildLauncher(RobotController rc, MapLocation newLoc) throws GameActionException {
