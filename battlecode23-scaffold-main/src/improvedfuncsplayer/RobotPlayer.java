...
public strictfp class RobotPlayer {
    ...
    static void runHeadquarters(RobotController rc) throws GameActionException {
        ...
        if (rc.getNumAnchors(Anchor.STANDARD) < 1 &&
                ...
                rc.getResourceAmount(ResourceType.MANA) > 200 && turnCount > 10) {
            buildAnchorSTD(rc);
        }
        if (rng.nextBoolean()) {
    ...
    static void runCarrier(RobotController rc) throws GameActionException {
        if (rc.canTakeAnchor(rc.getLocation().subtract(Direction.EAST), Anchor.STANDARD)) {
            rc.takeAnchor(rc.getLocation().subtract(Direction.EAST), Anchor.STANDARD);
        }
